...
from apps.categories.models import GradeCategories, MajorCategories
...
class Students(models.Model):
    ...
    province = models.ForeignKey(ProvinceCategories, related_name='users', null=True, on_delete=models.SET_NULL, verbose_name='استان')
    city = models.ForeignKey(CityCategories, related_name='users', null=True, on_delete=models.SET_NULL, verbose_name='شهر')
